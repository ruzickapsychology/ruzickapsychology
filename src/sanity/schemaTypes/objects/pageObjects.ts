import {DocumentTextIcon, HelpCircleIcon, LaunchIcon, NumberIcon} from '@sanity/icons'
...
export const therapySpaceSection = defineType({
  ...
  fields: [
    ...
    defineField({name: 'exteriorImage', title: 'Exterior image', type: 'imageWithAlt'}),
    defineField({name: 'interiorImage', title: 'Interior image', type: 'imageWithAlt'}),
  ],
})
